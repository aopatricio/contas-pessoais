...
<body style="margin: 0px auto">    
	...
	<nav> 
		<div class="container" style="margin: 5px 75px;">
			<div style="float: left; margin-left: 20px; margin-bottom: 20px;" >
				<form method="post" id="frmperiodo" action="layout.php?a=dashboard.php">
					<div class="content">
						<div class="row">
    ...
    // Tirando o while
						...
						?>
						<p style="font-size: 20px; text-align: center; border: solid 1px; border-color: black; background-color: grey; margin-left: 50px; color: blue;"><?php echo $novovalorreceita; ?></p>
    ...
    // Tirando o while
						...
						?>
						<p style="font-size: 20px; text-align: center; border: solid 1px; border-color: black; background-color: grey; margin-left: 50px; color: red;"><?php echo $novovalor; ?></p>
    ...
    // Tirando o while
						...
						?>
						<p style="font-size: 20px; border: solid 1px; text-align: center; border-color: black; background-color: grey; margin-left: 50px; text-align: center; color: <?php echo $cor; ?>;"><?php echo $novovalor; ?></p>

					</div>
					<?php 
					$saldoatual = date("d/m/Y");
					?>
					<div style=" float: left;">

						<p style="font-size: 20px; color: black; margin-left: 50px;">Saldo atual.: <?php  echo $saldoatual; ?> </p>
						<?php
						$varmesselecionado = date("m");
						$varanoselecionado = date("Y");
						...
						INNER JOIN conta As tb3 On tb1.conta_credito = tb3.id
						INNER JOIN tb_status As tb4 On tb1.pg = tb4.id
						WHERE MONTH(tb1.data)=$varmesselecionado and YEAR(tb1.data)=$varanoselecionado AND tb1.pg = 1"; 
						$queryvalor = mysqli_query($conexao, $queryvalor);
    ...
    //$novovalor = 'R$ ' . number_format($valor, 2, ',', '.');
						...
						?>
						<p style="font-size: 20px; margin-left: 50px; border: solid 1px; border-color: black; background-color: grey; text-align: center; color: <?php echo $cor; ?>;"><?php echo $novovalor; ?></p>
					...
					<div style=" float: left;">
						<p style="font-size: 20px; color: black; margin-left: 50px;">Maior gasto com.:</p>
						<?php
						...
						if(!isset($_POST['periodo'])) {
							...
							$queryvalor = "select tb2.name, COUNT(tb1.valor) 
							from lancamento AS tb1 
							INNER JOIN conta As tb2 On tb1.conta_credito = tb2.id 
							WHERE MONTH(tb1.data)=$varmesselecionado and YEAR(tb1.data)=$varanoselecionado and tb1.conta_credito != 1
							GROUP BY tb1.conta_credito
							ORDER BY COUNT(tb1.valor) DESC"; 
							$queryvalor = mysqli_query($conexao, $queryvalor);
						...
						<p style="font-size: 20px; margin-left: 50px; border: solid 1px; border-color: black; background-color: grey; text-align: center; color: blue"><?php echo $conta; ?></p>
				...
				<div>
					<nav style="clear: both; " >
						<p style="border: solid 1px; font-size: 20px; color: black; margin-left: 100px; text-align: center; background-color: gray;"> Lancamentos fixo da semana </p>
					</nav>
				</div>
				<div>
					<table style="margin-left: 100px; width: 1200px" id="myTable" class="table table-hover" > 
						...
						WHERE YEARWEEK(data, 1) = YEARWEEK(CURDATE(), 1) and tb1.despfixa = 1"; //" ORDER BY tb1.data ASC";
