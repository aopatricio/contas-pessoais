...
<html>
    <head>
      <title>Duplicar Lançamento</title>
        <meta charset="UTF-8">
...
<div id="id_test">
            ...
            <form method="post" id="rendered-form">
                <div class="rendered-form">
                    <div class="">
                        <h1 style=" margin-left: 20px;" id="formulario">Duplicar Lancamento</h1>
                    </div>
                    <div style="float: left; margin-left: 20px; width: 155px" class="fb-date form-group field-cmpdata">
                        ...
                        <input type="date" class="form-control" name="cmpdata" id="cmpdata" value="<?php echo $data; ?>">
                        ...
                        <div style="float: left; margin-left: 20px; width: 200px" class="fb-select form-group field-contadebito">
                            ...
                            <select class="form-control" name="contadebito" id="contadebito">
                             <option value="<?php echo $idcontadebito . ";" . $idcreditotipo;  ?>"><?php echo $debito; ?></option>
                       <?php
...
if(isset($_POST['add'])){
    ...
    if ($alt_credito[1] == '3') {
    $sqllancamento = "INSERT INTO lancamento (data, historico, conta_debito, conta_credito, valor, pg, despfixa) VALUES ( '$alt_data', '$alt_historico', '$alt_debito[0]', '$alt_credito[0]', '$alteravirgula', '$alt_pago', '$alt_despfixa')";
    }
    else{
