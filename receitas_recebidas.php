    ...
    <nav> 
        <div class="container" style="margin: 5px 75px;">
            <div style="float: left; margin-left: 20px; margin-bottom: 20px;" >
                <form method="post" id="frmperiodo" action="layout.php?a=receitas_recebidas.php">
                    <div class="content">
                        <div class="row">
...
<a href="#" onclick="frmperiodo.submit()"><button title="Clique para incluir um novo lançamento!" style="float: right; margin-left: 100px;  height: 32px; margin-top: 5px; font-size: 14px" type='button' class='btn btn-default btn-sm glyphicon glyphicon-search'> Pesquisar</button>
                ...
                <div>
                    ...
                    <?php
                        ...
                        WHERE MONTH(tb1.data)=$varmesselecionado and YEAR(tb1.data)=$varanoselecionado and tb1.conta_credito=1 and tb1.pg=1";
                    }
                     else {
                    ...
                    ?>
                           ...
                           <div style="float: left;">     
                            <p style="font-size: 20px; color: black; margin-left: 100px; width: 900px; text-align: center; background-color: gray;"> Receitas Recebidas no Mês: <?php echo $mes; ?> </p>
                        </div>
                        <div style="float: left;">
                ...
                <div>
                    ...
                    <?php
                        ...
                        INNER JOIN tb_status As tb4 On tb1.pg = tb4.id
                        INNER JOIN tb_status As tb5 On tb1.despfixa = tb5.id 
                        WHERE MONTH(tb1.data)=$varmesselecionado and YEAR(tb1.data)=$varanoselecionado and tb1.conta_credito=1 and tb1.pg=1 ORDER BY tb1.data ASC";
                    }
                     else {
